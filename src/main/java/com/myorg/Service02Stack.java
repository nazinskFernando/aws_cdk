...
//---------------------------SQS---------------------------------------------
        Queue productEventsDlq = Queue.Builder.create(this, "ProductEventDlq")
        ...
        ApplicationLoadBalancedFargateService service02 = ApplicationLoadBalancedFargateService.Builder.create(this, "ALB02")
                ...
                .taskImageOptions(
                        ApplicationLoadBalancedTaskImageOptions.builder()
                                ...
                                .image(ContainerImage.fromRegistry("nazinsk/curso_aws_project02:1.4.0"))
                                .containerPort(9090)
